...
openssl_md_meth_names = None # (!) real value is "frozenset({'sm3', 'shake_128', 'sha3_224', 'md5-sha1', 'sha3_512', 'sha256', 'sha512', 'blake2b', 'blake2s', 'sha1', 'md5', 'sha3_256', 'ripemd160', 'sha224', 'sha3_384', 'sha384', 'whirlpool', 'shake_256', 'sha512_256', 'md4', 'sha512_224'})"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f01200b5970>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f01200b5970>, origin='/usr/lib/python3.8/lib-dynload/_hashlib.cpython-38-x86_64-linux-gnu.so')"
