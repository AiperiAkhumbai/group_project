...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f01201d6430>'

__spec__ = None # (!) real value is "ModuleSpec(name='_lzma', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f01201d6430>, origin='/usr/lib/python3.8/lib-dynload/_lzma.cpython-38-x86_64-linux-gnu.so')"
