...
class DecimalTuple(tuple):
    ...
    digits = None # (!) real value is '<_collections._tuplegetter object at 0x7f011fd1fd30>'
    exponent = None # (!) real value is '<_collections._tuplegetter object at 0x7f011fd1feb0>'
    sign = None # (!) real value is '<_collections._tuplegetter object at 0x7f011fd1fdc0>'
    _fields = (
        'sign',
        'digits',
        'exponent',
...
__spec__ = None # (!) real value is "ModuleSpec(name='_decimal', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f011fda1430>, origin='/usr/lib/python3.8/lib-dynload/_decimal.cpython-38-x86_64-linux-gnu.so')"
