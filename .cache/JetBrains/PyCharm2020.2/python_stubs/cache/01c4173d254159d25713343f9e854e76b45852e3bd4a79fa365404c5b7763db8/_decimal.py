...
class DecimalTuple(tuple):
    ...
    digits = None # (!) real value is '<_collections._tuplegetter object at 0x7f4bd32c8d60>'
    exponent = None # (!) real value is '<_collections._tuplegetter object at 0x7f4bd32c8e80>'
    sign = None # (!) real value is '<_collections._tuplegetter object at 0x7f4bd32c8d90>'
    _fields = (
        'sign',
        'digits',
        'exponent',
...
__spec__ = None # (!) real value is "ModuleSpec(name='_decimal', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f4bd3248460>, origin='/usr/lib/python3.8/lib-dynload/_decimal.cpython-38-x86_64-linux-gnu.so')"
